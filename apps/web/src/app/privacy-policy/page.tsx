  ...
  return (
    ...
    >
      <LegalSection n="1" title="Who is responsible (controller)">
        <p>Ozvor is the controller of personal data described here. Ozvor is the trade name of a Brazilian individual micro-entrepreneur (MEI), registered under CNPJ 67.609.444/0001-08, with registered office at Rua José Borges Abrantes, nº 1, Centro, Muriaé — MG, CEP 36.880-063, Brazil. Privacy contact: <a href="mailto:dpo@ozvor.com" style={{ color: "var(--color-primary)" }}>dpo@ozvor.com</a>. A Brazilian Encarregado (LGPD Art. 41 / DPO) has been appointed and can be reached at <a href="mailto:dpo@ozvor.com" style={{ color: "var(--color-primary)" }}>dpo@ozvor.com</a>. An EU representative (GDPR Art. 27) is appointed before serving the EU/EEA market.</p>
      </LegalSection>
