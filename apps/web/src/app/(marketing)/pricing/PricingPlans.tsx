...
const PLANS: Plan[] = [
  ...
  },
  {
    ...
    features: ["Multi-client dashboard (up to 25 brands)", "10 competitors per brand", "Weekly monitoring on every client", "White-label reports", "Client approval workflow", "Priority support · 4h SLA", "Annual bonus: one free website GEO audit."],
    cta: "Start Agency",
    paid: true,
    accent: "emerald",
  },
