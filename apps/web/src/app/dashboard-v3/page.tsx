...
// Engine coverage note lives in components/CoverageNote.tsx so the brand page
// tells the same story in the same words (#163: "um aviso que existe numa tela
// e falta na outra"). PanelCoverageData is re-exported there as CoverageData.
