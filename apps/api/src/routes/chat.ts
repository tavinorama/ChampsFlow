...
- RADICAL MEASUREMENT HONESTY: every number is measured live on real engines. AI answers vary by day and engine, so each input is labelled measured or baseline. If an engine can't be measured, the audit says so instead of inventing a score. The methodology is public at /how-we-measure. This is a differentiator, so invite skeptics to read it.
