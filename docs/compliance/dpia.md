...
- **Update log**: 2026-07-24 (merged 2026-07-29) — added Section 12-GEO (sub-processor register cross-reference and non-product processing: Postiz, HeyGen, n8n cloud, Google Workspace; drafted 2026-07-24 as Section 11-GEO and renumbered 12-GEO at merge because 11-GEO was assigned to the Evidence Store on 2026-07-28); TL;DR addendum appended. No change to the residual risk finding in Section 9-GEO. See `docs/compliance/gate-log.md` (2026-07-24 entry) for the corresponding Gate 7 verdict, which also addresses the two still-open Gate 7 hard stops (EU Art. 27 representative, LGPD Encarregado) and flags that the live Privacy Policy currently overstates their appointment status.
