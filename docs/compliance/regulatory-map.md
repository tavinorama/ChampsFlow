...
> **2026-09-02 note**: brand in the TL;DR above reads "TrustIndex AI" only as history — the operating brand is **Ozvor** (rebrand 2026-06; founder rule: never reintroduce "TrustIndex" in live text). Also new since the TL;DR: CAN-SPAM is now ACTIVE scope (cold-outreach motion, ROPA G27–G29; postal-address gap = founder-accepted risk, see gate-log 2026-09-02); Art. 27 representative is DESIGNATED (the founder, Lisbon), signature pending.
