...
> **Rewritten 2026-09-02** (02/09 sweep; the 2026-07-10 TL;DR is superseded — kept in git history).

Entity CONFIRMED: **Ozvor**, Brazilian **MEI**, CNPJ **67.609.444/0001-08**, Muriaé — MG; regulator ANPD; governing law Brazil; contact dpo@ozvor.com. Legal pages LIVE and refreshed 02/09 (privacy: 12-month evidence retention aligned to ROPA G16, honest Art. 27 text; sub-processors page: 12 entries incl. SmartLead; cookies: `ozvor_attribution` sessionStorage; `/refund` + ToS §4: $49 30-day money-back). Compliance set current to 02/09: **ROPA G1–G30** (new: prospect-batch G27 with LIA, follow-up G28 — engines claude/codex only, Telegram masked; recycling G29 — erase after 3 cycles or 12 months, job pending; dossier G30), **SP-1..21** (11 ACCEPTED by founder 10/08; **10 NOT ASSESSED** — most urgent SmartLead SP-19, holding reply text since 10/08), DPIA §14-GEO (risks GEO-R16..R19), gate-log council verdicts for #526/#547/#561/#565 and the **honest Gate 7 OPEN entry** (production since July without a go-live verdict — recorded, not blessed). **Hard stops (founder)**: Encarregado Art. 41 + Art. 27 rep — both DECIDED (the founder; Lisbon residence covers Art. 27), instruments delivered 07/08, **signatures pending**. CAN-SPAM: opt-out line mandatory in the kits; **postal address = founder-accepted risk** (SOP §7, re-review at ~5k e-mails/month). Still orphaned/open (10.D.17): trademark Ozvor BR/EU/US (R-L5), manual countersigned-DPA process, external counsel pre-EU/BR-paid, `dpo@` routing confirmation, GEO-D1..D10, EV-1..9 closure verification.
...
> **Authoritative register: `docs/compliance/ropa.md` Sub-Processor Register (SP-1..SP-21)** — the table below is a launch-era snapshot kept for history. Live public page (ozvor.com/legal/sub-processors, updated 2 September 2026) lists **12** (the 11 below + SmartLead). Status as of 02/09: SP-1..SP-10 + SP-14 **ACCEPTED** (founder confirmation 2026-08-10; evidence in the founder's provider accounts); **NOT ASSESSED**: Postiz, HeyGen, n8n (SP-11..13), Telegram (SP-15), Signal Engine (SP-16), Pexels/Notion (SP-17/18), **SmartLead (SP-19 — urgent: stores prospect reply text since 10/08)**, Apify (SP-20, planned/blocked), GitHub Actions (SP-21). The kimi/Moonshot engine leg was removed from the follow-up chain (no DPA existed — 10.D.4).
...
- **2026-09-02** | Legal STATE refreshed by the 02/09 sweep (PR fix/docs-legal-truth) | TL;DR rewritten; DPA tracker re-pointed at the authoritative ROPA register (SP-1..21; 11 accepted, 10 not assessed, SmartLead most urgent). Same-day artifacts: ROPA G27–G30 + LIA, DPIA 14-GEO, council verdicts #526/#547/#561/#565, honest Gate 7 OPEN entry, legal-pages refresh (privacy 12-month retention, Art. 27 designated text, sub-processors 12, cookies attribution key, refund $49). CAN-SPAM postal address recorded as founder-accepted risk (SOP §7). Hard stops unchanged: 2 founder signatures (Encarregado + Art. 27). Historical entries preserved unedited.
